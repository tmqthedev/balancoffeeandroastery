 ...
 * @enum
 */
export declare const PasswordHashingAlgorithmType: {
    readonly ARGON2ID: "ARGON2ID";
    readonly BCRYPT: "BCRYPT";
    readonly PBKDF2_SHA256: "PBKDF2_SHA256";
    readonly SCRYPT: "SCRYPT";
};
/**
 * @public
 */
export type PasswordHashingAlgorithmType = (typeof PasswordHashingAlgorithmType)[keyof typeof PasswordHashingAlgorithmType];
/**
 * @public
 * @enum
 */
