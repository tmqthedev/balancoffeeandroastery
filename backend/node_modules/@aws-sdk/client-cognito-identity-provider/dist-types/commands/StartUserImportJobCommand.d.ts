...
declare const StartUserImportJobCommand_base: {
    new (input: StartUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<StartUserImportJobCommandInput, StartUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<StartUserImportJobCommandInput, StartUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
