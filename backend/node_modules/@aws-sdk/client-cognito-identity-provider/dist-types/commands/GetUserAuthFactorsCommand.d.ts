...
declare const GetUserAuthFactorsCommand_base: {
    new (input: GetUserAuthFactorsCommandInput): import("@smithy/core/client").CommandImpl<GetUserAuthFactorsCommandInput, GetUserAuthFactorsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUserAuthFactorsCommandInput): import("@smithy/core/client").CommandImpl<GetUserAuthFactorsCommandInput, GetUserAuthFactorsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
