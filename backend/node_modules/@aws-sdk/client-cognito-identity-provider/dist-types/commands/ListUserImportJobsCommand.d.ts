...
declare const ListUserImportJobsCommand_base: {
    new (input: ListUserImportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListUserImportJobsCommandInput, ListUserImportJobsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserImportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListUserImportJobsCommandInput, ListUserImportJobsCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
