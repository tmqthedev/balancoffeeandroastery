...
declare const DescribeUserImportJobCommand_base: {
    new (input: DescribeUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserImportJobCommandInput, DescribeUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserImportJobCommandInput, DescribeUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
