...
declare const DescribeUserPoolCommand_base: {
    new (input: DescribeUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolCommandInput, DescribeUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolCommandInput, DescribeUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
