...
declare const CreateUserPoolCommand_base: {
    new (input: CreateUserPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolCommandInput, CreateUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateUserPoolCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolCommandInput, CreateUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
