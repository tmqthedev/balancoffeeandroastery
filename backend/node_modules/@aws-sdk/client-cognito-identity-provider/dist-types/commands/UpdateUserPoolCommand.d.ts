...
declare const UpdateUserPoolCommand_base: {
    new (input: UpdateUserPoolCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolCommandInput, UpdateUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserPoolCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserPoolCommandInput, UpdateUserPoolCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
