...
exports.KeyObjectCache = exports.JwtVerifier = exports.JwtVerifierBase = exports.supportedSignatureAlgorithms = void 0;
...
exports.supportedSignatureAlgorithms = [
    "RS256",
    "RS384",
    "RS512",
    "ES256",
...
function validateJwtHeaderAndJwk(header, jwk) {
    ...
    (0, jwk_js_1.assertIsSignatureJwk)(jwk);
    ...
    (0, assert_js_1.assertStringArrayContainsString)("JWT signature algorithm", header.alg, exports.supportedSignatureAlgorithms, error_js_1.JwtInvalidSignatureAlgorithmError);
}
/**
 ...
 */
async function verifyJwt(jwt, jwksUri, options, jwkFetcher = jwk_js_1.fetchJwk, transformJwkToKeyObjectFn = _node_web_compat_1.nodeWebCompat.transformJwkToKeyObjectAsync) {
    return verifyDecomposedJwt((0, jwt_js_1.decomposeUnverifiedJwt)(jwt), jwksUri, options, jwkFetcher, transformJwkToKeyObjectFn);
}
/**
...
function verifyJwtSync(jwt, jwkOrJwks, options, transformJwkToKeyObjectFn = _node_web_compat_1.nodeWebCompat.transformJwkToKeyObjectSync) {
    return verifyDecomposedJwtSync((0, jwt_js_1.decomposeUnverifiedJwt)(jwt), jwkOrJwks, options, transformJwkToKeyObjectFn);
}
/**
...
class JwtVerifierBase {
        ...
        if (Array.isArray(verifyProperties)) {
            ...
            verifyProperties.forEach((prop, index) => {
                if (this.issuersConfig.has(prop.issuer)) {
                    ...
                    throw new error_js_1.ParameterValidationError(`issuer cannot be null when multiple issuers are supplied (at issuer: ${index})`);
                }
    ...
    getVerifyParameters(jwt, verifyProperties) {
        const decomposedJwt = (0, jwt_js_1.decomposeUnverifiedJwt)(jwt);
    ...
    withJwksUri(config) {
        ...
        if (!issuer) {
            throw new error_js_1.ParameterValidationError("jwksUri must be provided for issuer null");
        }
...
exports.JwtVerifierBase = JwtVerifierBase;
/**
